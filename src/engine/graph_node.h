...
struct GraphNodeBillboard           *init_graph_node_billboard           (struct GraphNodeBillboard           *graphNode, s32 drawingLayer, void *displayList, Vec3s translation, Vec3s axis, u8 isCylindrical);
