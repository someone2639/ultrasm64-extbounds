#ifndef MsODEL_TABLE_H
#define MsODEL_TABLE_H

#include "msodel_ids.h"
#include "types.h"
...
static  ModelIDs {
    ...
    [MODEL_WF_TOWER_TRAPEZOID_PLATORM]  = wf_geo_000AF8,
    [MODEL_WF_TOWER_SQUARE_PLATORM]        = wf_geo_000B10,
    [MODEL_WF_TOWER_SQUARE_PLATORM_UNUSED] = wf_geo_000B38,
    [MODEL_WF_TOWER_SQUARE_PLATORM_ELEVATOR] = wf_geo_000B60,
    ...
    [MODEL_SL_CRACKED_ICE]        = sl_geo_000360,
    [MODEL_SL_CRACKED_ICE_CHUNK]        = sl_geo_000378,
    ...
    [MODEL_TTC_PIT_BLOCK]        = ttc_geo_000310,
    [MODEL_TTC_PIT_BLOCK_UNUSED]        = ttc_geo_000328,
    ...
    [MODEL_RR_TRIANGLE_PLATFORM]        = rr_geo_0008D8,
    [MODEL_RR_CRUISER_WING]        = rr_geo_000890,
    [MODEL_RR_SEESAW_PLATFORM]        = rr_geo_000908,
    [MODEL_RR_L_SHAPED_PLATFORM]        = rr_geo_000940,
    ...
    [MODEL_BREAKABLE_BOX_SMALL] // = compatibility,
    ...
    [MODEL_FISH]        // fish_geo - fish without = used,
    [MODEL_FISH_SHADOW]        // fish_shadow_geo - fish with = unused,
    ...
    [MODEL_TRAJECTORY_MARKER_BALL]        // bowling_ball_track_geo - duplicate used in SSL Pyramid small sized and as a = ball,
