...
static const LevelScript script_rr_macro_objects[] = {
    ...
    // Special objects
    OBJECT(/*model*/ MODEL_rr_LEVEL_GEOMETRY_03, /*pos*/  1902, -1833,  1063, /*angle*/ 0,   0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvStaticObject),
    OBJECT(/*model*/ MODEL_rr_LEVEL_GEOMETRY_04, /*pos*/  3803, -1833,  2036, /*angle*/ 0,   0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvStaticObject),
    OBJECT(/*model*/ MODEL_rr_LEVEL_GEOMETRY_05, /*pos*/ -4888, -2550,  5847, /*angle*/ 0,   0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvStaticObject),
    OBJECT(/*model*/ MODEL_rr_LEVEL_GEOMETRY_06, /*pos*/  5324, -2038,  6155, /*angle*/ 0,   0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvStaticObject),
    OBJECT(/*model*/ MODEL_rr_LEVEL_GEOMETRY_07, /*pos*/  -409, -3164,  5207, /*angle*/ 0,   0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvStaticObject),
    OBJECT(/*model*/ MODEL_rr_LEVEL_GEOMETRY_08, /*pos*/ -3193, -4726,  6670, /*angle*/ 0,   0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvStaticObject),
    OBJECT(/*model*/ MODEL_rr_LEVEL_GEOMETRY_08, /*pos*/ -4680, -1910,   296, /*angle*/ 0,   0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvStaticObject),
    OBJECT(/*model*/ MODEL_rr_LEVEL_GEOMETRY_09, /*pos*/  6506, -1295,   762, /*angle*/ 0,   0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvStaticObject),
    OBJECT(/*model*/ MODEL_rr_LEVEL_GEOMETRY_0A, /*pos*/ -4629,   137,  -113, /*angle*/ 0,   0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvStaticObject),
    OBJECT(/*model*/ MODEL_rr_LEVEL_GEOMETRY_0B, /*pos*/  2639,  2724,  -622, /*angle*/ 0,   0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvStaticObject),
    OBJECT(/*model*/ MODEL_rr_LEVEL_GEOMETRY_0C, /*pos*/  3577,  2486, -2346, /*angle*/ 0,   0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvStaticObject),
    OBJECT(/*model*/ MODEL_rr_LEVEL_GEOMETRY_0D, /*pos*/   614, -1116,  3671, /*angle*/ 0,   0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvStaticObject),
    OBJECT(/*model*/ MODEL_rr_LEVEL_GEOMETRY_0D, /*pos*/  3554,  4276, -2346, /*angle*/ 0,   0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvStaticObject),
    OBJECT(/*model*/ MODEL_rr_LEVEL_GEOMETRY_0E, /*pos*/  5280,  4937,   603, /*angle*/ 0, 180, 0, /*behParam*/ 0x00000000, /*beh*/ bhvStaticObject),
    OBJECT(/*model*/ MODEL_rr_LEVEL_GEOMETRY_0F, /*pos*/ -4197,  4608, -5119, /*angle*/ 0,   0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvStaticObject),
    OBJECT(/*model*/ MODEL_rr_LEVEL_GEOMETRY_10, /*pos*/  2628,  -143, -1611, /*angle*/ 0,   0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvStaticObject),
    OBJECT(/*model*/ MODEL_rr_LEVEL_GEOMETRY_11, /*pos*/  5094,  3440,  4029, /*angle*/ 0,   0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvStaticObject),
    OBJECT(/*model*/ MODEL_rr_LEVEL_GEOMETRY_12, /*pos*/ -3708,  2006,   270, /*angle*/ 0,   0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvStaticObject),
    OBJECT(/*model*/ MODEL_rr_LEVEL_GEOMETRY_13, /*pos*/  5994,  -988,  1341, /*angle*/ 0,   0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvStaticObject),
    OBJECT(/*model*/ MODEL_rr_LEVEL_GEOMETRY_14, /*pos*/  3917,   624, -1133, /*angle*/ 0,   0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvStaticObject),
    OBJECT(/*model*/ MODEL_rr_LEVEL_GEOMETRY_15, /*pos*/ -3981,  3328, -2736, /*angle*/ 0,   0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvStaticObject),
    OBJECT(/*model*/ MODEL_rr_LEVEL_GEOMETRY_16, /*pos*/ -6053,  4096, -3197, /*angle*/ 0,   0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvStaticObject),
    RETURN(),
};
